# Sign and install — unique 2.0.4.5 scroll package
...
| DriverVer | `09/17/2026,2.0.4.5` (2.0.4.4 was `09/16/2026,2.0.4.4`; 2.0.4.3 was `09/15/2026,2.0.4.3`) | `08/30/2026,2.0.4.0` | pointer-only |
...
| SHA256 | 2.0.4.5 not built yet; 2.0.4.3 was signed `0CC4458B…` / unsigned freeze `25A3287A…` (26112 bytes) | `845435CE…` refuse | `AD5D244B…` restore baseline |
